...
2. Fetch the canonical hash from:
   ```
   https://raw.githubusercontent.com/YOUR_ORG/YOUR_PUBLIC_REPO/main/onboarding/hashes.txt
   ```
...
3. The hash published in YOUR_PUBLIC_REPO is the source of truth. The file contents are not.
