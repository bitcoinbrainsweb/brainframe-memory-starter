...
2. AI reads INTEGRITY.md → verifies file hash against YOUR_PUBLIC_REPO
...
Upstream (`YOUR_MEMORY_STARTER_REPO`). Updates propagate to peer forks via template-sync PRs.
