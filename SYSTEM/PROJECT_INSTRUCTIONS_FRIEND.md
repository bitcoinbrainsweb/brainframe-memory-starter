...
You are connected to Project Owner via the peer-intel-exchange pattern.
...
This is optional for the friend role. You can add your own memory fork later if you want persistent context across sessions — see `YOUR_MEMORY_STARTER_REPO` on GitHub.
